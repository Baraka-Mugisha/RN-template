...
## Project Structure
    ...
    ├── restless_limit_36830  # Django project configurations
...
1. Clone this repo and `cd restless_limit_36830`
...
2. Clone this repo and `cd restless_limit_36830`
