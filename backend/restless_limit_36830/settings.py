"""
Django settings for restless_limit_36830 project.
...
LOCAL_APPS = [
    'home',
    'home.api.v1.users.apps.UserConfig',
]
THIRD_PARTY_APPS = [
    'rest_framework',
...
ROOT_URLCONF = 'restless_limit_36830.urls'
...
WSGI_APPLICATION = 'restless_limit_36830.wsgi.application'
...
ACCOUNT_ADAPTER = "home.api.v1.users.adapters.AccountAdapter"
SOCIALACCOUNT_ADAPTER = "home.api.v1.users.adapters.SocialAccountAdapter"
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'restless_limit_36830.pagination.CustomPagination',
